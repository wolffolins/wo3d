...
var etmeshLoader = new THREE.ColladaLoader();
etmeshLoader.load('ET2.dae', function (etmesh) {
	console.log(etmesh);
	etCube = etmesh;
etCube.scene.scale.set(50, 50, 50);

scene.add(etCube.scene);
});
